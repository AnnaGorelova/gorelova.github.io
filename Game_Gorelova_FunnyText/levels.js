...
function calculateMaxAvailableLevel(playerName) {
    console.log('=== РАСЧЕТ ДОСТУПНОГО УРОВНЯ ===');
    ...
    console.log('Official прохождения игрока:', playerOfficialSessions);
    ...
    if (level1Sessions.length > 0) {
        ...
        console.log('Лучший результат уровня 1:', bestLevel1);
        
        if (bestLevel1 >= 20) {
            console.log('Уровень 2 доступен');
            maxLevel = 2;
            ...
            if (level2Sessions.length > 0) {
                ...
                console.log('Лучший результат уровня 2:', bestLevel2);
                
                if (bestLevel2 >= 28) {
                    console.log('Уровень 3 доступен');
                    maxLevel = 3;
                } else {
                    console.log('Уровень 3 НЕ доступен: нужно 28+ баллов в уровне 2');
                }
            } else {
                console.log('Уровень 2 не пройден');
            }
        } else {
            console.log('Уровень 2 НЕ доступен: нужно 20+ баллов в уровне 1');
        }
    } else {
        console.log('Уровень 1 не пройден в official режиме');
    }
    
    console.log('Максимальный доступный уровень:', maxLevel);
    return maxLevel;
}
...
function startLevel(level) {
    ...
    console.log('Запуск уровня', level, 'в official режиме');
...
function startPractice() {
    ...
    console.log('Запуск практики уровня', level);
...
function setupEventListeners() {
    ...
    if (practiceBtn) {
        console.log('Кнопка практики найдена');
...
function showProfile() {
    ...
    console.log('Все сессии игрока:', playerSessions);
    
    const levelStats = {};
    for (let level = 1; level <= 3; level++) {
        // Фильтруем сессии именно этого уровня
        const levelSessions = playerSessions.filter(s => s.level === level);
        console.log(`Уровень ${level} сессии:`, levelSessions);
    ...
    console.log('Статистика по уровням:', levelStats);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol style="margin-left: 1.5rem; margin-bottom: 1rem;">
                    ...
                    <li>Уровень 1 открыт всегда, остальные - по результатам</li>
                ...
                <ul style="margin-left: 1.5rem; margin-bottom: 1rem;">
                    <li><strong>Уровень 1:</strong> Перетаскивание слов по частям речи</li>
                    <li><strong>Уровень 2:</strong> Подбор слов в пропуски текста</li>
