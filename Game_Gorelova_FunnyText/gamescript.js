class SplashScreen {
    ...
    loadPlayersHistory() {
        try {
            ...
            console.error('Ошибка при загрузке истории пользователей:', error);
            this.playersHistory = [];
        }
    }
    ...
    savePlayersHistory() {
        try {
            ...
            console.error('Ошибка при сохранении истории пользователей:', error);
        }
    }
    ...
    transferProgressToHistory(playerName) {
        try {
            ...
            console.error('Ошибка при переносе прогресса:', error);
        }
    }
